# Take the Json file and make it a list of dictionaries, similar to what we did before.
# Now the elements we want to use are the correct_answer and the question
question_data = [
